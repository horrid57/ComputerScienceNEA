...
sf::Texture enemyAttackingAxis;
sf::Texture enemyAttackingDiagonal;
sf::Texture enemyAttackedAxis;
sf::Texture enemyAttackedDiagonal;
sf::Texture enemyDamageCooldownAxis;
sf::Texture enemyDamageCooldownDiagonal;
